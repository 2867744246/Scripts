...
public class LaneSystem : MonoBehaviour
{
    ...
    [Tooltip("道路最左侧边缘的 Z 坐标")]
    public float roadEdge = 0f;
    ...
    /// 获取指定车道的中心 Z 坐标
    /// </summary>
    /// <param name="laneIndex">车道索引（0: 最左侧车道，1: 右侧车道，以此类推）</param>
    ...
    public float GetLanePosition(int laneIndex)
    {
        ...
        // 从左边缘开始计算：左边缘 + (车道索引 + 0.5) * 车道宽度
        return roadEdge + (laneIndex + 0.5f) * laneWidth;
    }
    ...
    private void DrawLaneLines()
    {
        ...
        for (int i = 0; i <= laneCount; i++)
        {
            ...
            // i=1: 中间分隔线（对于 2 车道）
            // i=2: 最右侧边界
            float zPos = roadEdge + i * laneWidth;
